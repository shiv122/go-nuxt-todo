<template>
    <section class="bg-gray-50 min-h-screen flex items-center justify-center">
        <!-- login container -->
        <div class="bg-gray-100 flex rounded-2xl shadow-lg p-5 items-center">
            <!-- form -->
            <div class="px-8 md:px-16">
                ...
                <form @submit.prevent="handleSubmit" class="flex flex-col gap-4">
                    <input v-model="email" class="p-2 mt-8 rounded-xl border" type="test" required name="email"
                        placeholder="Email">
                    <div class="relative">
                        <input v-model="password" class="p-2 rounded-xl border w-full" type="password" required
...
<script setup>
import { useErrorHandler } from "~/composables/errorHandlers"
